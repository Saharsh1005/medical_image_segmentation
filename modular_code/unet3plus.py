# -*- coding: utf-8 -*-
"""
Created on Tue Jul 26 17:43:27 2022
Citation:   https://github.com/ZJUGiveLab/UNet-Version/blob/master/models/UNet_3Plus.py
@author: Saharsh
"""
...
from unetblock import UnetConv2
...
class UNet3Plus(nn.Module):
    ...
    def __init__(self, in_channels=3, n_classes=1, feature_scale=4, is_deconv=True, is_batchnorm=True):
        ...
        # h2->160*160, hd4->32*32, Pooling 4 times
        ...
        # h3->80*80, hd4->32*32, Pooling 2 times
        ...
        # hd5->20*20, hd4->32*32, Upsample 2 times
        ...
        # output
        self.outconv1 = nn.Conv2d(self.up_channels, n_classes, 3, padding=1)
    ...
    def forward(self, inputs):
        ...
        h5 = self.maxpool4(h4)
        hd5 = self.conv5(h5)     # h5->16*16*1024
        ...
        hd4 = self.relu4d_1(self.bn4d_1(self.conv4d_1(
            torch.cat((h1_pt_hd4, h2_pt_hd4, h3_pt_hd4, h4_cat_hd4, hd5_ut_hd4), 1)))) # hd4->32*32*up_channels
        ...
        hd3 = self.relu3d_1(self.bn3d_1(self.conv3d_1(
            torch.cat((h1_pt_hd3, h2_pt_hd3, h3_cat_hd3, hd4_ut_hd3, hd5_ut_hd3), 1)))) # hd3->64*64*up_channels
        ...
        hd2 = self.relu2d_1(self.bn2d_1(self.conv2d_1(
            torch.cat((h1_pt_hd2, h2_cat_hd2, hd3_ut_hd2, hd4_ut_hd2, hd5_ut_hd2), 1)))) # hd2->128*128*up_channels
        ...
        hd1 = self.relu1d_1(self.bn1d_1(self.conv1d_1(
            torch.cat((h1_cat_hd1, hd2_ut_hd1, hd3_ut_hd1, hd4_ut_hd1, hd5_ut_hd1), 1)))) # hd1->256*256*up_channels

        d1 = self.outconv1(hd1)  # d1->256*256*n_classes(0 or 1)
        return d1 #mutually exclusive classes (nuclei or not)